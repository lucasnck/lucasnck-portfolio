...
export default function GTM(props: IGTMProps) {
  return (
    <svg viewBox="0 0 2469.7 2469.8">
      <g>
        <path fill="#6e25c8" d="M1449.8,2376L1021,1946.7l921.1-930.5l436.7,436.6L1449.8,2376z" />
        <path
          fill="#591ba5"
        ...
        />
        <circle fill="#8e56ff" cx="1231.2" cy="2163.9" r="306" />
      </g>
    </svg>
  );
}
