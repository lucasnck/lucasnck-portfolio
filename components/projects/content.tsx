...
export const projects = [
  {
    ...
    description: (
      <>
        Modular platform for customers. <br />
        <p>
  ...
  },
  {
    ...
    background: "linear-gradient(-45deg, #2c07d1, #2856ec, #114fc4, #2d0ca3)",
    title: (
      <>
        Partners Portal <br /> BTG+ Business
      </>
    ),
    description: (
      <>
        Modular platform for partners, administrative/operation and partners. <br />
        <p>
          technologies: JavaScript, React, Vanilla, NextJS, AWS, Azure DevOps, jQuery, Bootstrap, SmartAdmin, Webpack,
          NodeJS, ANTD, Rest APIs, DevExtreme, Git Submodules, Micro-frontend, multirepo, monorepo, npm, yarn, git,
          CSS3/SASS, styled-components, NextJS, CMS, SCRUM.
  ...
  {
    id: "adminbtgmaisbusiness",
    logo: "/images/btgmaisbusiness.svg",
    background: "linear-gradient(-45deg, #2c2b2a, #5b2885, #1c1e1f, #5b2885)",
    title: (
      <>
        Admin Portal <br /> BTG+ Business
      </>
    ),
    description: (
      <>
        Modular platform for admin, administrative/operation and partners. <br />
        <p>
          technologies: JavaScript, React, Vanilla, NextJS, AWS, Azure DevOps, jQuery, Bootstrap, SmartAdmin, Webpack,
          NodeJS, ANTD, Rest APIs, DevExtreme, Git Submodules, Micro-frontend, multirepo, monorepo, npm, yarn, git,
          CSS3/SASS, styled-components, NextJS, CMS, SCRUM.
